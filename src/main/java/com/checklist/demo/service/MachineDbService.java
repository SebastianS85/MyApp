...
public class MachineDbService {
    ...
    public Machine getMachineBySerialNumber(String serialNumber){return machineRepository.findByMachineSerialNumber(serialNumber); }

    public void   deleteMachineBySerialNumber(String serialNumber){ machineRepository.deleteByMachineSerialNumber(serialNumber);}
}
